const  XBOT = 'TorengBot'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/dio_pro_awm'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285700168193'; // Nomor whatsapplu cok
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:DioGanz\n' // full name
            + 'ORG:Owner  DioGanz Bot;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=6285700168193:+62 857-0016-8193\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @DioGanz`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @DioGanz`)
})
...
conn.sendMessage(id, 'Owner TorengBot wa.me/+6285700168193' ,MessageType.text);
}
else if (text == 'DioGanz'){
conn.sendMessage(id, 'Aku BOT nya Toreng' ,MessageType.text);
}
else if (text == 'audio'){
...
conn.sendMessage(id, menu.menu(id,  TorengBot, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '#donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  TorengBot, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
